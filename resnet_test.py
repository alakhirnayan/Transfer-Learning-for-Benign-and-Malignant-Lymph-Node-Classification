...
model = tf.keras.models.load_model('/root/Downloads/V/models/resnet/best_model.h5')
#model = tf.keras.models.load_model('/content/gdrive/My Drive/CODE/models/resnet/model_36E.h5')
model.summary()
...
plt.savefig("/root/Downloads/V/gambar/resnet/test/CMNN_resnet50.png")

plotcmn = plt.figure(6) 
plot_confusion_matrix(confusion_matrix, ['Benign','Malignant'],normalize=True)
plt.savefig("/root/Downloads/V/gambar/resnet/test/CMN_resnet50_Norm")
...
os.remove('/root/Downloads/V/models/resnet/model_11E.h5')
os.remove('/root/Downloads/V/models/resnet/best_model.h5')
# In[ ]: