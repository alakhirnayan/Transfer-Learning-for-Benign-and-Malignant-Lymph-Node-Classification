...
#    time.sleep(.5)
    bt_prediction = InceptionV3.predict(images)  
...
model = tf.keras.models.load_model('/root/Downloads/V/models/inception/best_model.h5')
#model = tf.keras.models.load_model('/content/gdrive/My Drive/CODE/models/inception/model_36E.h5')
model.summary()
...
plt.savefig("/root/Downloads/V/gambar/inception/test/CMNN_InceptionV3.png")

plotcmn = plt.figure(6) 

plot_confusion_matrix(confusion_matrix, ['Benign','Malignant'],normalize=True)
plt.savefig("/root/Downloads/V/gambar/inception/test/CMN_InceptionV3_Norm.png")
# plt.savefig('gambar/inception/test/50e/CMN_InceptionV3_50E')
...
os.remove('/root/Downloads/V/models/inception/model_11E.h5')
os.remove('/root/Downloads/V/models/inception/best_model.h5')
# In[ ]: