...
#model = tf.keras.models.load_model('/content/gdrive/My Drive/CODE/models/vgg16/model_36E.h5')
model.summary()
...
plt.savefig("/root/Downloads/V/gambar/vgg16/test/CMNN_vgg16.png")

plotcmn = plt.figure(6) 
plot_confusion_matrix(confusion_matrix, ['Benign','Malignant'],normalize=True)
plt.savefig("/root/Downloads/V/gambar/vgg16/test/CMN_vgg16_Norm")
# plt.savefig('gambar/vgg16/test/50e/CMN_vgg16_50E')
os.remove('/root/Downloads/V/models/vgg16/model_11E.h5')
os.remove('/root/Downloads/V/models/vgg16/best_model.h5')
