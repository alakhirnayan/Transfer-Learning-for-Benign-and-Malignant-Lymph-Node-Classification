...
plt.legend()
plotacc.show()
plt.savefig("/root/Downloads/V/gambar/vgg16/train/Acc_vgg16_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))
...
plt.legend()
plotloss.show()
plt.savefig("/root/Downloads/V/gambar/vgg16/train/Loss_vgg16_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))
...
plt.savefig("/root/Downloads/V/gambar/vgg16/train/CMNN_vgg16_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))

plotcmn = plt.figure(4) 
plot_confusion_matrix(confusion_matrix, ['Benign','Malignant'],normalize=True)
plt.savefig("/root/Downloads/V/gambar/vgg16/train/CMN_vgg16_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))
