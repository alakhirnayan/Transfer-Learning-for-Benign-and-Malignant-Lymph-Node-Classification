...
model = tf.keras.models.load_model('/root/Downloads/V/models/xception/best_model.h5')
#model = tf.keras.models.load_model('/content/gdrive/My Drive/CODE/models/xception/model_36E.h5')
model.summary()
...
plt.savefig("/root/Downloads/V/gambar/xception/test/CMNN_Xception.png")

plotcmn = plt.figure(6) 
plot_confusion_matrix(confusion_matrix, ['Benign','Malignant'],normalize=True)
plt.savefig("/root/Downloads/V/gambar/xception/test/CMN_Xception_Norm")
# plt.savefig('gambar/Xception/test/50e/CMN_Xception_50E')
...
os.remove('/root/Downloads/V/models/xception/model_11E.h5')
os.remove('/root/Downloads/V/models/xception/best_model.h5')
# In[ ]: