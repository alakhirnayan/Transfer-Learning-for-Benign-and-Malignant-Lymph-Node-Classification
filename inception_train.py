...
mc = ModelCheckpoint('/root/Downloads/V/models/inception/best_model.h5', monitor='val_acc', mode='max', verbose=1, save_best_only=True)
...
#Model di save 
model.save('/root/Downloads/V/models/inception/model_{}E.h5'.format(len(acc)))
...
plt.legend()
plotacc.show()
plt.savefig("/root/Downloads/V/gambar/inception/train/Acc_InceptionV3_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))
...
plt.legend()
plotloss.show()
plt.savefig("/root/Downloads/V/gambar/inception/train/Loss_InceptionV3_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))
...
plt.savefig("/root/Downloads/V/gambar/inception/train/CMNN_InceptionV3_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))

plotcmn = plt.figure(4) 
plot_confusion_matrix(confusion_matrix, ['Benign','Malignant'],normalize=True)
plt.savefig("/root/Downloads/V/gambar/inception/train/CMN_InceptionV3_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))
