...
mc = ModelCheckpoint('/root/Downloads/V/models/xception/best_model.h5', monitor='val_acc', mode='max', verbose=1, save_best_only=True)
...
#Model di save 
model.save('/root/Downloads/V/models/xception/model_{}E.h5'.format(len(acc)))
...
plt.legend()
plotacc.show()
plt.savefig("/root/Downloads/V/gambar/xception/train/Acc_Xception_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))
...
plt.legend()
plotloss.show()
plt.savefig("/root/Downloads/V/gambar/xception/train/Loss_Xception_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))
...
plt.savefig("/root/Downloads/V/gambar/xception/train/CMNN_Xception_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))

plotcmn = plt.figure(4) 
plot_confusion_matrix(confusion_matrix, ['Benign','Malignant'],normalize=True)
plt.savefig("/root/Downloads/V/gambar/xception/train/CMN_Xception_{}Batch_{}E_Opt={}_lr={}.png".format(batch_size, len(acc),opt,lr))
